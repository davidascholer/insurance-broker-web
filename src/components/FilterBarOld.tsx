/*
Keep this file for reference if the old layout is desired.
- Shows insurers
- Filters by ALL selected options (instead of ONLY currenlty selected option)
*/
...
//         <div>
//           <DropdownMenu>
//             <DropdownMenuTrigger className="mr-auto text-(--primary-coral) hover:text-(--coral-light) transition-colors duration-300 cursor-pointer nunito-sans-medium">
...
//         >
//           <span className="text-(--primary-coral) text-sm">Back To Top</span>
//           <ListFilter size={20} className="text-(--primary-coral)" />
//         </button>
//         <ChatBot
//           className=""
//           open={chatbotOpen}
