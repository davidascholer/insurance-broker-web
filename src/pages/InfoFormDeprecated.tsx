...
// import { InfoFormCarousel } from "@/components/forms/InfoFormCarousel";
...
const InfoForm = () => {
  ...
  //       <InfoFormBanner />
  //       <InfoFormCarousel answers={answers} />
  //       {/* <div className="flex flex-row gap-8 flex-wrap items-center justify-start p-8 w-full fixed top-0 z-100 pb-18 mask-b-from-65% bg-(--light-pink)"> */}
