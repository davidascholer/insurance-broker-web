  ...
  return (
    <div className="bg-(--light-pink) pt-24">
      ...
      <SectionBackground color="bg-(--light-pink)">
        <div className="flex flex-row flex-wrap justify-center items-center gap-12 p-8 max-w-7xl mx-auto">
          <a
            ...
            rel="noreferrer"
            className="text-(--primary-teal) text-center font-extrabold whitespace-pre-wrap self-start tracking-widest"
          >
            FOR RESCUE SHELTERS
          </a>
          <a
      ...
      <SectionBackground color="bg-(--primary-teal-dark) ">
        <h2
          id="rescue-shelters"
          className="text-2xl sansita-bold whitespace-pre-wrap text-white"
        >
      ...
      <SectionBackground color="bg-(--primary-coral) ">
        <h2
          ...
          className="text-2xl sansita-bold whitespace-pre-wrap text-white"
        >
          We make quality care accessible for every pet through partnerships
          with veterinarians.
        </h2>
      </SectionBackground>
      <SectionBackground color="bg-white" className="p-2">
